...
import { updateSylebusUrl } from "@/src/Utils/Urls/SylebusUrl";

const Transition = React.forwardRef(function Transition(props, ref) {
  return <Slide direction="up" ref={ref} {...props} />;
});

const UploadSylebusModal = ({ Sylebus }) => {
  ...
  const handelUpdate = async (updatedata) => {
    ...
    setLoading(true);
    const res = await fetch(updateSylebusUrl(_id), {
      method: "PATCH",
      headers: {
...
export default UploadSylebusModal;
