          ...
          headersData.map((header) => {
            return (
              <div className="grid-cols-4 text-white md:grid">
                <div className="flex justify-between items-center col-span-3 gap-3 px-2 ">
                    <div className="flex gap-3 items-center">
                         <Image
                          ...
                          <div className="text-start">
                            ...
                            <h2 className="md:text-xl text-md font-bold">{header?.schoolName}</h2>
                    ...
                    <button onClick={()=> setOpen(!open)}>
                         <BiMenu  className="text-4xl md:hidden block" />
                    </button>
                </div>
